                ...
                <div class="flex items-center p-4 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <div class="flex">
                        <button data-modal-hide="postJob-modal" data-modal-target="timeline-modal"
                            data-modal-show="timeline-modal" {{-- type="submit" form="formRoom" --}}
                    ...
                    <div class="relative mb-4 md:mb-5">
                        <div tabindex="0"
                            ...
                            <div class="flex flex-wrap gap-4 mb-3 ">
                                ...
                                <div
                                    class="z-0 flex items-center justify-center w-10 h-10 text-center rounded-md bg-e73002">
                                ...
                                {{-- <div class="relative flex-1 min-w-[200px] mb-5 group">
                                    <input type="text" name="pathTittle" id="pathTittle"
                                        class="block w-full px-0 py-2 text-base font-bold text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-e73002 peer"
                                        placeholder="Masukkan Judul" />
                                    <label for="pathTittle"
                                        class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-e73002 peer-focus:dark:e73002 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Tahapan
                                        Pertama</label>
                                </div>
                                <select
                                    class="type-selection block w-full p-2 mb-6 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 flex-none min-w-[150px] sm:w-auto">
                            ...
                            <div class="grid grid-cols-5 gap-4 uploud-berkas">
                                <div class="col-span-5">
                                    <label for="pemberkasan_deskripsi"
                                ...
                                <div class="col-span-5">
                                    ...
                                    <textarea id="pemberkasan_deskripsi" name="pemberkasan_deskripsi" rows="4"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Masukkan deskripsi seleksi"></textarea>
                                </div>
                                <div class="col-span-2 ">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rentang
                                        waktu</label>
                                    <div date-rangepicker class="flex items-center">
                                        <div class="relative">
                                            ...
                                            <input name="pemberkasan_start" type="text"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Mulai">
                                        </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input name="pemberkasan_end" type="text"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Selesai">
                                        </div>
                                    </div>
                                ...
                                <div class="col-span-2 col-end-6 ">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="small_size">Lampiran</label>
                                    <input name="lampiran_pemberkasan"
                            ...
                            <div class="grid grid-cols-5 gap-4 challange-selection" style="display: none;">
                                ...
                                <div class="col-span-5">
                                    <label for="challange_deskripsi"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi</label>
                                    <textarea id="challange_deskripsi" name="challange_deskripsi" rows="4"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Masukkan deskripsi seleksi"></textarea>
                                </div>
                                <div class="col-span-5">
                                    <label for="lampiran_challange"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link
                                        lampiran Challange</label>
                                    <input type="text" name="lampiran_challange" id="lampiran_challange"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="Masukkan lokasi atau link online meeting">
                                </div>
                                <div class="col-span-2 ">
                                    ...
                                    <div date-rangepicker class="flex items-center">
                                        <div class="relative">
                                            ...
                                            <input name="challange_start" type="text"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Mulai">
                                        </div>
                                        <span class="mx-4 text-gray-500">to</span>
                                        <div class="relative">
                                            ...
                                            <input name="challange_end" type="text"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Selesai">
                                        </div>
                                    </div>
                            ...
                            <div class="grid grid-cols-5 gap-4 meet-invitation-selection" style="display: none;">
                                <div class="col-span-5">
                                    <label for="meetInvitation_deskripsi"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi</label>
                                    <textarea id="meetInvitation_deskripsi" name="meetInvitation_deskripsi" rows="4"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Masukkan deskripsi seleksi"></textarea>
                                </div>
                                <div class="col-span-5">
                                    <label for="meetInvitation_location"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lokasi /
                                        Link Meeting</label>
                                    <input type="text" name="meetInvitation_location" id="meetInvitation_location"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="Masukkan lokasi atau link online meeting" required>
                                </div>
                                <div class="col-span-2">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rentang
                                        waktu</label>
                                    <div date-rangepicker class="flex items-center">
                                        <div class="relative">
                                            ...
                                            <input name="meetInvitation_start" type="text"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Mulai">
                                        </div>
                                        <span class="mx-4 text-gray-500">to</span>
                                        <div class="relative">
                                            ...
                                            <input name="meetInvitation_end" type="text"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Selesai">
                                        </div>
                                    </div>
                                ...
                                <div class="col-span-2 col-end-6 ">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="small_size">Lampiran</label>
                                    <input name="lampiran_meetInvitation"
                                        class="block w-full mb-5 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                        id="small_size" type="file">
                                </div>
                            </div>
                            <!-- Card footer -->
                            {{-- <div
                                class="flex items-center justify-between border-t border-gray-200 rounded-b dark:border-gray-600">
                                <div class="flex items-center gap-2 mt-2">
                                    <button type="button"
                                        class="flex items-center justify-center w-8 h-8 text-sm font-medium text-white rounded-full btn-up-path hover:bg-gray-300">
                                    ...
                                    <button type="button"
                                        class="flex items-center justify-center w-8 h-8 text-sm font-medium text-white rounded-full btn-down-path hover:bg-gray-300">
                                        <svg class="w-6 h-6 text-gray-500" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            fill="none" viewBox="0 0 24 24">
                                            <path stroke="currentColor" stroke-linecap="round"
                                ...
                                <button type="button"
                                    class="flex items-center justify-center w-8 h-8 mt-2 text-sm font-medium text-white rounded-full btn-delete-path hover:bg-gray-300">
                                    <svg class="w-6 h-6 text-gray-500" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        fill="none" viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        {{-- <button id="addPathBtn" type="button"
                            class="text-gray-600 gap-2 border border-dashed inline-flex w-full justify-center hover:bg-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center shadow-md">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function addNewPath() {
            ...
            typeSelection.addEventListener('change', (event) => {
                ...
                newPath.querySelector('.uploud-berkas').style.display = (value === 'uploudBerkas' ?
                    'grid' : 'none');
                newPath.querySelector('.challange-selection').style.display = (value === 'Challange' ?
                    'grid' : 'none');
                newPath.querySelector('.meet-invitation-selection').style.display = (value ===
                    'meetInvitation' ? 'grid' : 'none');
            });
        ...
        paths.forEach(path => {
            ...
            switch (pathData.type) {
                ...
                case 'Challange':
                    ...
                    break;
                case 'meetInvitation':
                    pathData.description = path.querySelector('textarea[name="meetInvitation_deskripsi"]')
                        .value;
