    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <div class="bg-white hover:bg-gray-50 ">
                ...
                <div scope="row" class="flex border items-center px-6 py-4 text-gray-900 whitespace-nowrap ">
                    <div class="flex">
                        <img class="w-12 h-12 border rounded-lg" src="{{ url('images/logoJobMatch.png') }}" alt="Jese image">
                        <div class="ps-3">
                            ...
                            <div class="flex mt-2 gap-2">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <span class="text-xs">Negoitable</span>
                                </div>
                            </div>
                        </div>  
                    </div>
                    <div class="flex flex-col items-end ml-auto">
                        <button type="button" class="w-8 h-8 p-1 text-center inline-flex items-center">
