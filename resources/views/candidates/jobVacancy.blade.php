                ...
                <div class="md:flex mt-4">
                    <ul class="flex-column space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0"  id="jobVacancy-tab" data-tabs-toggle="#jobVacancy-tab-content" role="tablist">
                        ...
                        <li class="me-2" role="presentation">
                            <button class="inline-flex p-2 bg-slate-100 text-white rounded-lg active w-full justify-center"  id="jobVacancy{{ $room->id }}-tab" data-tabs-target="#jobVacancy{{ $room->id }}" type="button" role="tab" aria-controls="jobVacancy{{ $room->id }}" aria-selected="false">
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 mt-2 gap-4 items-center justify-center rounded ">
                                        <div class="flex items-center p-1 rounded bg-fd7d09 dark:bg-gray-800">
                                           <h1 class=" text-xs font-medium leading-none tracking-tight text-white  dark:text-white">Posisi dibuka : <span class="text-xs font-bold text-white dark:text-blue-500">{{ $room->total_open_position }}</span></h1>
                                        </div>
                                        <div class="flex items-center p-1 rounded bg-fd1d02 dark:bg-gray-800">
                                           <h1 class=" text-xs font-medium leading-none tracking-tight text-white  dark:text-white">Total Pendaftar : <span class="text-xs font-bold text-white dark:text-blue-500">236</span></h1>
                                        </div>
                                     </div>
                                </div>
                            </button>
