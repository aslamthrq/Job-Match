                ...
                <div class="md:flex mt-4">
                    <ul class="flex-column space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0"  id="jobVacancy-tab" data-tabs-toggle="#jobVacancy-tab-content" role="tablist">
                        <li class="me-2" role="presentation">
                            <button class="inline-flex p-2 bg-slate-100 text-white rounded-lg active w-80 items-center justify-center"  id="jobVacancy1-tab" data-tabs-target="#jobVacancy1" type="button" role="tab" aria-controls="jobVacancy1" aria-selected="false">
                                <div>
                                    <div class="flex">
                        ...
                        <li class="me-2" role="presentation">
                            <button class="inline-flex p-2 bg-slate-100 text-white rounded-lg active w-80 items-center justify-center"  id="jobVacancy2-tab" data-tabs-target="#jobVacancy2" type="button" role="tab" aria-controls="jobVacancy2" aria-selected="false">
                                <div>
                                    <div class="flex">
                                        <img class="w-16 h-16 border rounded-lg" src="{{ url('images/logoJobMatch.png') }}" alt="Jese image">
                                        {{-- Keterangan --}}
                    ...
                    <div id="jobVacancy-tab-content" class="p-6 bg-slate-100 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full">
                        <div class="relative rounded-lg " id="jobVacancy1" role="tabpanel" aria-labelledby="jobVacancy1-tab">
                            @include('candidates.components.detailCard')
                        </div>
                        <div class="relative rounded-lg " id="jobVacancy2" role="tabpanel" aria-labelledby="jobVacancy2-tab">
                            Ini konten job kedua
                        </div>
                    </div>
                </div>
