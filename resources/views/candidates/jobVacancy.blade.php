            ...
            <div class="relative mb-4 overflow-x-auto rounded-lg">
                ...
                <div class="mt-4 md:flex">
                    <ul class="mb-4 space-y-4 text-sm font-medium text-gray-500 flex-column space-y dark:text-gray-400 md:me-4 md:mb-0"
                        id="jobVacancy-tab" data-tabs-toggle="#jobVacancy-tab-content" role="tablist">
                        @foreach ($rooms as $room)
                            <li class="me-2" role="presentation">
                                <button
                                    class="inline-flex justify-center w-full p-2 text-white rounded-lg bg-slate-100 active"
                                    id="jobVacancy{{ $room->id }}-tab"
                                    data-tabs-target="#jobVacancy{{ $room->id }}" type="button" role="tab"
                                    aria-controls="jobVacancy{{ $room->id }}" aria-selected="false">
                                    <div>

                                        <div class="flex">
                                            <img class="w-16 h-16 border rounded-lg"
                                            ...
                                            <div class="ps-3">
                                                <div class="flex items-center gap-4 text-base font-bold text-gray-800">
                                                    <span class="text-xs text-left text-gray-500">
                                                        {{ $room->position_name }}</span>
                                                    <span
                                                        class="inline-flex items-center bg-negative text-white text-xs font-semibold px-2 py-0.5 rounded-full">
                                                        {{ $room->work_system }}
                                                    </span>
                                                </div>
                                                <div class="flex gap-2 my-1">
                                                    <div class="flex items-center">
                                                        <span
                                                            class="text-xs text-gray-400">{{ $room->company->company_name }}</span>
                                                    </div>
                                                </div>
                                                <div class="flex gap-2">
                                                    <div class="flex items-center">
                                                        ...
                                                        <span
                                                            class="text-xs text-gray-400">{{ $room->company->company_address }}</span>
                                                    </div>
                                        ...
                                        <div class="grid items-center justify-center grid-cols-2 gap-4 mt-2 rounded ">
                                            <div class="flex items-center p-1 rounded bg-fd7d09 dark:bg-gray-800">
                                                <h1
                                                    class="text-xs font-medium leading-none tracking-tight text-white dark:text-white">
                                                    Posisi dibuka : <span
                                                        class="text-xs font-bold text-white dark:text-blue-500">{{ $room->total_open_position }}</span>
                                                </h1>
                                            </div>
                                            <div class="flex items-center p-1 rounded bg-fd1d02 dark:bg-gray-800">
                                                <h1
                                                    ...
                                                    Total Pendaftar : <span
                                                        class="text-xs font-bold text-white dark:text-blue-500">{{ $room->candidates()->count() }}</span>
                                                </h1>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div id="jobVacancy-tab-content"
                        class="w-full p-6 text-gray-500 rounded-lg bg-slate-100 text-medium dark:text-gray-400 dark:bg-gray-800">
                        @foreach ($rooms as $room)
                            <div class="relative rounded-lg " id="jobVacancy{{ $room->id }}" role="tabpanel"
                                aria-labelledby="jobVacancy{{ $room->id }}-tab">
