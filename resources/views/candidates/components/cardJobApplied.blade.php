<a href="statusDetail" class="inline-flex p-2 bg-slate-100 text-white rounded-lg active" aria-current="page">
    <div class="w-full">
        ...
        <div class="mt-4 p-2 bg-gray-50  rounded-xl">
            <ul class="flex items-center w-full text-sm font-medium text-center text-e73002 sm:text-base" id="default-tab" data-tabs-toggle="#default-tab-content" data-tabs-active-classes="text-e73002" data-tabs-inactive-classes="text-gray-500" role="tablist">
                <li class="flex md:w-full items-center sm:after:content-[''] after:w-full after:h-1 after:border-b after:border-e73002 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 " role="path point selection">
                    <button class="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200" id="participant-tab" data-tabs-target="#participant" type="button" role="tab" aria-controls="participant" aria-selected="true">
                        <div class="ps-3">
                            <span class="inline-flex items-center justify-center w-6 h-6 bg-gray-200 rounded-full ">
                                <svg  class="w-3 h-3 text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                            ...
                            <div class="flex text-xs items-center after:content-['/']  sm:after:hidden after:mx-2 after:text-gray-200">
                ...
                <li class="flex  md:w-full items-center  sm:after:content-[''] after:w-full after:h-1 after:border-b after:border-e73002 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 " role="path point selection">
                    <button class="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200 " id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">
                        <div class="ps-3">
                            ...
                            <span class="flex items-center text-xs after:content-['/']  sm:after:hidden after:mx-2 after:text-gray-200 ">
                ...
                <li class="flex items-center" role="path point selection">
                    <button class="me-2 flex" id="settings-tab" data-tabs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="false">
                        <div class="ps-3">
                            ...
                            <div class="flex items-center text-xs after:content-['/']  sm:after:hidden after:mx-2 after:text-gray-200">
