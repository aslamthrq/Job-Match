...
<div id="pathsContainer" class="relative mb-4 md:mb-5"> 
   <div id="pathTemplate" tabindex="0" class="path-selection mb-2 rounded-md p-4 bg-white focus:outline-none focus-within:border-l-8 focus-within:border-e73002 shadow-md" style="display: none;">
    <div class="flex flex-wrap gap-4">
        ...
        <select class="type-selection block w-full p-2 mb-6 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 flex-none min-w-[150px] sm:w-auto" name="pathType[]">
       ...
       <div class="uploud-berkas grid grid-cols-5 gap-4" style="display: none;">
            <div class="col-span-5">
                <label for="deskripsiBerkas" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi</label>
                <textarea name="deskripsiBerkas[]" id="deskripsiBerkas" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan deskripsi seleksi"></textarea>
            </div>

       </div>
       <div class="challange-selection grid grid-cols-5 gap-4" style="display: none;">
        <div class="col-span-5">
            <label for="deskripsiChallange" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi</label>
            <textarea name="deskripsiChallange[]" id="deskripsiChallange" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan deskripsi seleksi"></textarea>
        </div>

       </div>
       <div class="meet-invitation-selection grid grid-cols-5 gap-4" style="display: none;">
        <div class="col-span-5">
            <label for="deskripsiMeet" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi</label>
            <textarea name="deskripsiMeet[]" id="deskripsiMeet" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan deskripsi seleksi"></textarea>
        </div>
